...
public class CategoryController {
    ...
    public ResponseEntity<ResponseModel>putCategoryByIdController(@RequestBody CategoryModel categoryModel){
        try {
            //request
            ...
            //response
            ResponseModel response = new ResponseModel();
            response.setMsg( "Category successfully update");
            response.setData(category);
            return ResponseEntity.ok(response);
    ...
    public ResponseEntity<ResponseModel>deleteCategoryController(@RequestBody CategoryModel categoryModel){
        try {
            ...
            //response
            ResponseModel response = new ResponseModel();
            response.setMsg( "Category successfully deleted");
            response.setData(category);
            return ResponseEntity.ok(response);
