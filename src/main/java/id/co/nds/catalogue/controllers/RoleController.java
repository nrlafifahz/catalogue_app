...
public class RoleController {
    ...
    public ResponseEntity<ResponseModel>putRoleByIdController(@RequestBody RoleModel roleModel){
        try {
            //request
            ...
            //response
            ResponseModel response = new ResponseModel();
            response.setMsg( "Role successfully update");
            response.setData(role);
            return ResponseEntity.ok(response);
    ...
    public ResponseEntity<ResponseModel>deleteRoleController(@RequestBody RoleModel roleModel){
        try {
            ...
            //response
            ResponseModel response = new ResponseModel();
            response.setMsg( "Role successfully deleted");
            response.setData(role);
            return ResponseEntity.ok(response);
